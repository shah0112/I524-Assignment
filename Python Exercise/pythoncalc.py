...
class Calculator(cmd.Cmd):
      ...
      def help_multiply(self):
              print('\n'.join([
                      'Multiply [number,]',
                      'Multiply all following arguments with the product of the previous arguments.'
              ]))
      ...
      def help_divide(self):
              print('\n'.join([
                      'Divide [number,]',
                      'Divide first argument by the second and divide this value by the third and so on.'
              ]))
